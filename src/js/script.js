...
const overlayPrevBtn = overlay.querySelector(".lightbox-gallery__nav--prev:not(.mobile)");
const overlayNextBtn = overlay.querySelector(".lightbox-gallery__nav--next:not(.mobile)");
